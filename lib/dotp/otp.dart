...
// https://pub.flutter-io.cn/packages/otp   otp 2.2.1
...
class OTP {
  ...
  static void _showHOTPWarning(Hash mac) {
    if (mac is Sha256 || mac is Sha512) {
      print('Using non-SHA1 hashing with HOTP is not part of the RFC for HOTP and may cause incompatibilities between different library implementatiions. This library attempts to match behavior with other libraries as best it can.');
    }
  }
